  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute -bottom-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-info-bg/50 blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group relative bg-white rounded-2xl p-8 border border-border shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:border-primary-100 transition-all duration-300">
            ...
            <div className="w-16 h-16 rounded-xl bg-primary-50 text-primary/90 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary-600 group-hover:text-white transition-all duration-300 shadow-sm">
          ...
          <div className="group relative bg-white rounded-2xl p-8 border border-border shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:border-primary-100 transition-all duration-300 mt-0 md:mt-16">
            ...
            <h3 className="text-xl font-bold text-foreground mb-3 relative z-10">Receive Deliveries</h3>
            <p className="text-muted-foreground relative z-10 leading-relaxed">
