              ...
              <form onSubmit={(e) => handleSubmit(e, pos)} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-3 py-2 text-sm border rounded focus:ring-primary-600 focus:border-primary-600"
                  />
                </div>
                ...
                <div className="md:col-span-2 pt-2 text-right">
                  <button 
                    ...
                    className="bg-primary-600 text-white px-4 py-1.5 text-sm rounded font-medium hover:bg-primary-700 disabled:opacity-50 transition-colors"
                  >
                    Save Slot {pos}
                  </button>
                </div>
