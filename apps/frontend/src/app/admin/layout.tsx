...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 flex flex-col md:flex-row relative pb-20 md:pb-0">
        {/* Desktop Sidebar */}
        ...
        {/* Main Content */}
        <ScrollFade as="main" className="flex-1 py-6 md:pl-8 md:py-8 overflow-y-auto">
