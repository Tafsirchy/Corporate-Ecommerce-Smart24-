          ...
          <div className="space-y-2">
            ...
            {isUploadMode ? (
              <input
                ...
                className="w-full px-4 py-2 border rounded focus:ring-black focus:border-black file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-gray-50 file:text-black hover:file:bg-gray-100"
              />
            ) : (
              <input 
                key="url-input"
            ...
            {brands.map(brand => (
              <tr key={brand.id} className="hover:bg-gray-50">
                ...
                <td className="p-4 flex gap-3">
                  <button onClick={() => startEdit(brand)} className="text-gray-400 hover:text-black" title="Edit">
                    <Edit2 size={16} />
                  </button>
                  <button onClick={() => handleDelete(brand.id)} className="text-gray-400 hover:text-red-500" title="Delete">
                    <Trash2 size={16} />
                  </button>
                </td>
              </tr>
