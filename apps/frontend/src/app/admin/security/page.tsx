        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          {!qrCode ? (
            ...
            <div className="mt-5 border-t border-gray-200 pt-5">
              <h4 className="text-sm font-medium text-gray-900">1. Scan this QR Code</h4>
              ...
              <div className="mt-3 text-sm text-gray-500">
                Or enter this code manually: <strong className="text-gray-900">{secret}</strong>
              </div>

              <h4 className="mt-6 text-sm font-medium text-gray-900">2. Enter the 6-digit code</h4>
              <div className="mt-2 flex items-center gap-3">
                <input
                  type="text"
                  placeholder="000000"
                  className="block w-32 rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 px-3 tracking-widest text-center"
                  value={code}
