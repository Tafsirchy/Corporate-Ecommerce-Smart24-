        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            {!show2fa ? (
              ...
              <div>
                <input
                  type="text"
                  required
                  className="relative block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 px-3 text-center tracking-widest"
          ...
          {!show2fa && (
            <div className="text-sm text-center flex flex-col gap-2 mt-4">
              <Link href="/forgot-password" className="font-medium text-gray-500 hover:text-gray-900">
