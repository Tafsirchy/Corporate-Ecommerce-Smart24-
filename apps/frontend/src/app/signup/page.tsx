          ...
          <div className="-space-y-px rounded-md shadow-sm">
            ...
            <div>
              <input
                type="email"
                required
                className="relative block w-full border-0 py-1.5 text-foreground ring-1 ring-inset ring-gray-300 placeholder:text-muted-foreground focus:z-10 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 px-3"
