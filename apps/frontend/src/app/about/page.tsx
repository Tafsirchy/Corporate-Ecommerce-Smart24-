    ...
    <div className="bg-white">
      ...
      <div className="relative -mt-32">
        <div className="container mx-auto px-4 mb-24">
          <div className="rounded-2xl bg-white shadow-xl px-6 py-12 sm:px-12 lg:px-16 text-foreground">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-foreground mb-6 mt-12">What We Do</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-lg">
              <div>
                <h3 className="font-semibold text-foreground text-xl mb-2">B2B Subscriptions</h3>
              ...
              <div>
                <h3 className="font-semibold text-foreground text-xl mb-2">Retail Marketplace</h3>
            ...
            <h2 className="text-3xl font-bold tracking-tight text-foreground mb-6 mt-12">Our Values</h2>
