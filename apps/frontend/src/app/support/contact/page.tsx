              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">support@smart24.com</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mt-1">Sat-Thu from 9am to 6pm.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">123 Business Avenue,<br/>Dhaka, Bangladesh</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all outline-none bg-white"
                    >
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={handleChange}
                      rows={6}
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all outline-none resize-none"
                  ...
                  {formData.subject === 'Order Issue' && user && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Select Order (Optional)</label>
                      <select
                        name="orderId"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Attachment / Image URL (Optional)</label>
                    <input 
                      type="url" 
                      name="attachmentUrl"
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">Paste a link to your image (e.g. ImgBB, Google Drive)</p>
                  </div>
